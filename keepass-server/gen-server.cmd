...
set "CERT_ALIAS=svr_%CERT_HOSTNAME%"
...
%KEYTOOL% -gencert -keystore %SIGN_KEYSTORE% -storepass %SIGN_PASS% -alias %SIGN_ALIAS% -validity 365 -ext "SubjectAlternativeName=dns:%CERT_CN%" -ext "KeyUsage:critical=digitalSignature,keyEncipherment" -ext "ExtendedKeyUsage=serverAuth" -infile %OUT_KEYSTORE%.csreq -outfile %OUT_KEYSTORE%.csresp
